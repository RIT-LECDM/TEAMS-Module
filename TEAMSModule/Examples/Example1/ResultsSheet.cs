...
namespace TEAMSModule
{
    public partial class ResultsSheet : Form
    {
        ...
        public List<double> T14_FSM = new List<double>();
        public List<double> T14_FSA = new List<double>();
        public List<double> T14_FM = new List<double>();
        public List<double> T14_FA = new List<double>();
        public List<double> T14_OM = new List<double>();
        public List<double> T14_OA = new List<double>();
        public List<double> T14_Total = new List<double>();
        public List<double> T14_CentFS = new List<double>();
        public List<double> T14_CentF = new List<double>();
        public List<double> T14_CentO = new List<double>();
        #endregion
        #region Table 15 Variable Lists
        public List<double> T15_RO = new List<double>();
        public List<double> T15_LSD = new List<double>();
        public List<double> T15_NG = new List<double>();
        public List<double> T15_BD = new List<double>();
        public List<double> T15_FTD = new List<double>();
        ...
        public void populateListsWithResults()
        {
            ...
            T14_CentO.Add(12);
            #endregion
            #region Table 15 List Population
            T15_RO.Add(0);
            T15_RO.Add(1);
            T15_RO.Add(2);
            T15_RO.Add(3);
        ...
        public void correctNumbersDisplayed()
        {
            ...
            #endregion
            #region Tabl3 15 numericUpDown assignments
            numericUpDown1148.Value = (decimal)T15_RO.ElementAt(0);
            numericUpDown1144.Value = (decimal)T15_RO.ElementAt(1);
            numericUpDown1140.Value = (decimal)T15_RO.ElementAt(2);
            numericUpDown1136.Value = (decimal)T15_RO.ElementAt(3);
            numericUpDown1132.Value = (decimal)T15_RO.ElementAt(4);
            numericUpDown1128.Value = (decimal)T15_RO.ElementAt(5);
            numericUpDown1124.Value = (decimal)T15_RO.ElementAt(6);
            numericUpDown1120.Value = (decimal)T15_RO.ElementAt(7);
            numericUpDown1116.Value = (decimal)T15_RO.ElementAt(8);
            numericUpDown1112.Value = (decimal)T15_RO.ElementAt(9);
            numericUpDown1108.Value = (decimal)T15_RO.ElementAt(10);
            numericUpDown1104.Value = (decimal)T15_RO.ElementAt(11);
            numericUpDown1100.Value = (decimal)T15_RO.ElementAt(12);

            numericUpDown1150.Value = (decimal)T15_LSD.ElementAt(0);
            numericUpDown1154.Value = (decimal)T15_LSD.ElementAt(1);
            numericUpDown1156.Value = (decimal)T15_LSD.ElementAt(2);
            numericUpDown1158.Value = (decimal)T15_LSD.ElementAt(3);
            numericUpDown1162.Value = (decimal)T15_LSD.ElementAt(4);
            numericUpDown1164.Value = (decimal)T15_LSD.ElementAt(5);
            numericUpDown1166.Value = (decimal)T15_LSD.ElementAt(6);
            numericUpDown1170.Value = (decimal)T15_LSD.ElementAt(7);
            numericUpDown1172.Value = (decimal)T15_LSD.ElementAt(8);
            numericUpDown1174.Value = (decimal)T15_LSD.ElementAt(9);
            numericUpDown1169.Value = (decimal)T15_LSD.ElementAt(10);
            numericUpDown1161.Value = (decimal)T15_LSD.ElementAt(11);
            numericUpDown1153.Value = (decimal)T15_LSD.ElementAt(12);

            numericUpDown1152.Value = (decimal)T15_NG.ElementAt(0);
            numericUpDown1155.Value = (decimal)T15_NG.ElementAt(1);
            numericUpDown1157.Value = (decimal)T15_NG.ElementAt(2);
            numericUpDown1160.Value = (decimal)T15_NG.ElementAt(3);
            numericUpDown1163.Value = (decimal)T15_NG.ElementAt(4);
            numericUpDown1165.Value = (decimal)T15_NG.ElementAt(5);
            numericUpDown1168.Value = (decimal)T15_NG.ElementAt(6);
            numericUpDown1171.Value = (decimal)T15_NG.ElementAt(7);
            numericUpDown1173.Value = (decimal)T15_NG.ElementAt(8);
            numericUpDown1175.Value = (decimal)T15_NG.ElementAt(9);
            numericUpDown1167.Value = (decimal)T15_NG.ElementAt(10);
            numericUpDown1159.Value = (decimal)T15_NG.ElementAt(11);
            numericUpDown1151.Value = (decimal)T15_NG.ElementAt(12);

            numericUpDown1146.Value = (decimal)T15_BD.ElementAt(0);
            numericUpDown1142.Value = (decimal)T15_BD.ElementAt(1);
            numericUpDown1138.Value = (decimal)T15_BD.ElementAt(2);
            numericUpDown1134.Value = (decimal)T15_BD.ElementAt(3);
            numericUpDown1130.Value = (decimal)T15_BD.ElementAt(4);
            numericUpDown1126.Value = (decimal)T15_BD.ElementAt(5);
            numericUpDown1122.Value = (decimal)T15_BD.ElementAt(6);
            numericUpDown1118.Value = (decimal)T15_BD.ElementAt(7);
            numericUpDown1114.Value = (decimal)T15_BD.ElementAt(8);
            numericUpDown1110.Value = (decimal)T15_BD.ElementAt(9);
            numericUpDown1106.Value = (decimal)T15_BD.ElementAt(10);
            numericUpDown1102.Value = (decimal)T15_BD.ElementAt(11);
            numericUpDown1098.Value = (decimal)T15_BD.ElementAt(12);

            numericUpDown1145.Value = (decimal)T15_FTD.ElementAt(0);
            numericUpDown1141.Value = (decimal)T15_FTD.ElementAt(1);
            numericUpDown1137.Value = (decimal)T15_FTD.ElementAt(2);
            numericUpDown1133.Value = (decimal)T15_FTD.ElementAt(3);
            numericUpDown1129.Value = (decimal)T15_FTD.ElementAt(4);
            numericUpDown1125.Value = (decimal)T15_FTD.ElementAt(5);
            numericUpDown1121.Value = (decimal)T15_FTD.ElementAt(6);
            numericUpDown1117.Value = (decimal)T15_FTD.ElementAt(7);
            numericUpDown1113.Value = (decimal)T15_FTD.ElementAt(8);
            numericUpDown1109.Value = (decimal)T15_FTD.ElementAt(9);
            numericUpDown1105.Value = (decimal)T15_FTD.ElementAt(10);
            numericUpDown1101.Value = (decimal)T15_FTD.ElementAt(11);
            numericUpDown1097.Value = (decimal)T15_FTD.ElementAt(12);
            #endregion
        }
